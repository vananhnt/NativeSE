...
public class Environment {
    ...
    public String takeInstance() {
        ...
        for (char c = '0'; c <= '9'; c++) {
            myStr.append(",\"", c, "\":", Arithmetic.bitSetToLong(register.get(c).getVal()));
        }
        myStr.append(",\"x\":", Arithmetic.bitSetToLong(register.get('x').getVal()));
        myStr.append(",\"e\":", Arithmetic.bitSetToLong(register.get('e').getVal()));
        myStr.append(",\"t\":", Arithmetic.bitSetToLong(register.get('t').getVal()));
        myStr.append(",\"s\":", Arithmetic.bitSetToLong(register.get('s').getVal()));
        myStr.append(",\"l\":", Arithmetic.bitSetToLong(register.get('l').getVal()));
        myStr.append(",\"p\":", Arithmetic.bitSetToLong(register.get('p').getVal()), "}");
        return myStr.value();
    }

    public BitVec value(Character r) {
        if (register.get(r) != null)
