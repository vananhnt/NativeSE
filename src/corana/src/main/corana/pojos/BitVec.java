...
public class BitVec {
    ...
    public BitVec(String sym, BitSet val, boolean isTaint) {
        this.taint = isTaint;
        if (sym.contains("SYM")) {
            this.sym = sym;
            this.val = val;
    ...
    public BitVec(Integer n, boolean isTaint) {
        this.sym = Arithmetic.intToHexSmt(n);
        this.val = Arithmetic.intToBitSet(n);
        this.taint = isTaint;
    }
    ...
    public BitVec getPrev() {return prev;}
    ...
    public void setPrev(BitVec pre) {
        this.prev = pre;
    }
    public void clear() {
        this.taint = false;
