...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkLinearOrder(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlong a2, jlong a3) {
  Z3_ast result = Z3_mk_linear_order((Z3_context)a0, (unsigned)a1, (Z3_ast)a2, (Z3_ast)a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkPartialOrder(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlong a2, jlong a3) {
  Z3_ast result = Z3_mk_partial_order((Z3_context)a0, (unsigned)a1, (Z3_ast)a2, (Z3_ast)a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkPiecewiseLinearOrder(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlong a2, jlong a3) {
  Z3_ast result = Z3_mk_piecewise_linear_order((Z3_context)a0, (unsigned)a1, (Z3_ast)a2, (Z3_ast)a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkTreeOrder(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlong a2, jlong a3) {
  Z3_ast result = Z3_mk_tree_order((Z3_context)a0, (unsigned)a1, (Z3_ast)a2, (Z3_ast)a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkTransitiveReflexiveClosure(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_func_decl result = Z3_mk_transitive_reflexive_closure((Z3_context)a0, (Z3_func_decl)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverSetActivity(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jdouble a3) {
  Z3_solver_set_activity((Z3_context)a0, (Z3_solver)a1, (Z3_ast)a2, (double)a3);
}
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALsolverToDimacsString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_string result = Z3_solver_to_dimacs_string((Z3_context)a0, (Z3_solver)a1);
  return jenv->NewStringUTF(result);
}
