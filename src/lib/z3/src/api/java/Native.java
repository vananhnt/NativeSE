...
public final class Native {
  ...
  protected static native long INTERNALmkLinearOrder(long a0, int a1, long a2, long a3);
  protected static native long INTERNALmkPartialOrder(long a0, int a1, long a2, long a3);
  protected static native long INTERNALmkPiecewiseLinearOrder(long a0, int a1, long a2, long a3);
  protected static native long INTERNALmkTreeOrder(long a0, int a1, long a2, long a3);
  protected static native long INTERNALmkTransitiveClosure(long a0, long a1);
  protected static native long INTERNALmkTransitiveReflexiveClosure(long a0, long a1);
  ...
  protected static native void INTERNALsolverSetActivity(long a0, long a1, long a2, double a3);
  ...
  protected static native String INTERNALsolverToDimacsString(long a0, long a1);
  ...
  public static long mkLinearOrder(long a0, int a1, long a2, long a3) throws Z3Exception
  {
      long res = INTERNALmkLinearOrder(a0, a1, a2, a3);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long mkPartialOrder(long a0, int a1, long a2, long a3) throws Z3Exception
  {
      long res = INTERNALmkPartialOrder(a0, a1, a2, a3);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long mkPiecewiseLinearOrder(long a0, int a1, long a2, long a3) throws Z3Exception
  {
      long res = INTERNALmkPiecewiseLinearOrder(a0, a1, a2, a3);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long mkTreeOrder(long a0, int a1, long a2, long a3) throws Z3Exception
  {
      long res = INTERNALmkTreeOrder(a0, a1, a2, a3);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long mkTransitiveReflexiveClosure(long a0, long a1) throws Z3Exception
  {
      long res = INTERNALmkTransitiveReflexiveClosure(a0, a1);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static void solverSetActivity(long a0, long a1, long a2, double a3) throws Z3Exception
  {
      INTERNALsolverSetActivity(a0, a1, a2, a3);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
  }
  ...
  public static String solverToDimacsString(long a0, long a1) throws Z3Exception
  {
      String res = INTERNALsolverToDimacsString(a0, a1);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
