...
void log_Z3_mk_linear_order(Z3_context a0, unsigned a1, Z3_ast a2, Z3_ast a3);
#define LOG_Z3_mk_linear_order(_ARG0, _ARG1, _ARG2, _ARG3) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_mk_linear_order(_ARG0, _ARG1, _ARG2, _ARG3); }
void log_Z3_mk_partial_order(Z3_context a0, unsigned a1, Z3_ast a2, Z3_ast a3);
#define LOG_Z3_mk_partial_order(_ARG0, _ARG1, _ARG2, _ARG3) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_mk_partial_order(_ARG0, _ARG1, _ARG2, _ARG3); }
void log_Z3_mk_piecewise_linear_order(Z3_context a0, unsigned a1, Z3_ast a2, Z3_ast a3);
#define LOG_Z3_mk_piecewise_linear_order(_ARG0, _ARG1, _ARG2, _ARG3) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_mk_piecewise_linear_order(_ARG0, _ARG1, _ARG2, _ARG3); }
void log_Z3_mk_tree_order(Z3_context a0, unsigned a1, Z3_ast a2, Z3_ast a3);
#define LOG_Z3_mk_tree_order(_ARG0, _ARG1, _ARG2, _ARG3) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_mk_tree_order(_ARG0, _ARG1, _ARG2, _ARG3); }
...
void log_Z3_mk_transitive_reflexive_closure(Z3_context a0, Z3_func_decl a1);
#define LOG_Z3_mk_transitive_reflexive_closure(_ARG0, _ARG1) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_mk_transitive_reflexive_closure(_ARG0, _ARG1); }
