...
void exec_Z3_mk_linear_order(z3_replayer & in) {
  Z3_ast result = Z3_mk_linear_order(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    in.get_uint(1),
    reinterpret_cast<Z3_ast>(in.get_obj(2)),
    reinterpret_cast<Z3_ast>(in.get_obj(3)));
...
void exec_Z3_mk_partial_order(z3_replayer & in) {
  Z3_ast result = Z3_mk_partial_order(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    in.get_uint(1),
    reinterpret_cast<Z3_ast>(in.get_obj(2)),
    reinterpret_cast<Z3_ast>(in.get_obj(3)));
...
void exec_Z3_mk_piecewise_linear_order(z3_replayer & in) {
  Z3_ast result = Z3_mk_piecewise_linear_order(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    in.get_uint(1),
    reinterpret_cast<Z3_ast>(in.get_obj(2)),
    reinterpret_cast<Z3_ast>(in.get_obj(3)));
...
void exec_Z3_mk_tree_order(z3_replayer & in) {
  Z3_ast result = Z3_mk_tree_order(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    in.get_uint(1),
    reinterpret_cast<Z3_ast>(in.get_obj(2)),
    reinterpret_cast<Z3_ast>(in.get_obj(3)));
...
void exec_Z3_mk_transitive_reflexive_closure(z3_replayer & in) {
  Z3_func_decl result = Z3_mk_transitive_reflexive_closure(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    reinterpret_cast<Z3_func_decl>(in.get_obj(1)));
  in.store_result(result);
}
...
void register_z3_replayer_cmds(z3_replayer & in) {
  ...
  in.register_cmd(159, exec_Z3_get_seq_sort_basis, "Z3_get_seq_sort_basis");
  in.register_cmd(160, exec_Z3_mk_re_sort, "Z3_mk_re_sort");
  in.register_cmd(161, exec_Z3_is_re_sort, "Z3_is_re_sort");
  in.register_cmd(162, exec_Z3_get_re_sort_basis, "Z3_get_re_sort_basis");
  in.register_cmd(163, exec_Z3_mk_string_sort, "Z3_mk_string_sort");
  in.register_cmd(164, exec_Z3_is_string_sort, "Z3_is_string_sort");
  in.register_cmd(165, exec_Z3_mk_string, "Z3_mk_string");
  in.register_cmd(166, exec_Z3_mk_lstring, "Z3_mk_lstring");
  in.register_cmd(167, exec_Z3_is_string, "Z3_is_string");
  in.register_cmd(168, exec_Z3_get_string, "Z3_get_string");
  in.register_cmd(169, exec_Z3_mk_seq_empty, "Z3_mk_seq_empty");
  in.register_cmd(170, exec_Z3_mk_seq_unit, "Z3_mk_seq_unit");
  in.register_cmd(171, exec_Z3_mk_seq_concat, "Z3_mk_seq_concat");
  in.register_cmd(172, exec_Z3_mk_seq_prefix, "Z3_mk_seq_prefix");
  in.register_cmd(173, exec_Z3_mk_seq_suffix, "Z3_mk_seq_suffix");
  in.register_cmd(174, exec_Z3_mk_seq_contains, "Z3_mk_seq_contains");
  in.register_cmd(175, exec_Z3_mk_seq_extract, "Z3_mk_seq_extract");
  in.register_cmd(176, exec_Z3_mk_seq_replace, "Z3_mk_seq_replace");
  in.register_cmd(177, exec_Z3_mk_seq_at, "Z3_mk_seq_at");
  in.register_cmd(178, exec_Z3_mk_seq_nth, "Z3_mk_seq_nth");
  in.register_cmd(179, exec_Z3_mk_seq_length, "Z3_mk_seq_length");
  in.register_cmd(180, exec_Z3_mk_seq_index, "Z3_mk_seq_index");
  in.register_cmd(181, exec_Z3_mk_seq_last_index, "Z3_mk_seq_last_index");
  in.register_cmd(182, exec_Z3_mk_str_to_int, "Z3_mk_str_to_int");
  in.register_cmd(183, exec_Z3_mk_int_to_str, "Z3_mk_int_to_str");
  in.register_cmd(184, exec_Z3_mk_seq_to_re, "Z3_mk_seq_to_re");
  in.register_cmd(185, exec_Z3_mk_seq_in_re, "Z3_mk_seq_in_re");
  in.register_cmd(186, exec_Z3_mk_re_plus, "Z3_mk_re_plus");
  in.register_cmd(187, exec_Z3_mk_re_star, "Z3_mk_re_star");
  in.register_cmd(188, exec_Z3_mk_re_option, "Z3_mk_re_option");
  in.register_cmd(189, exec_Z3_mk_re_union, "Z3_mk_re_union");
  in.register_cmd(190, exec_Z3_mk_re_concat, "Z3_mk_re_concat");
  in.register_cmd(191, exec_Z3_mk_re_range, "Z3_mk_re_range");
  in.register_cmd(192, exec_Z3_mk_re_loop, "Z3_mk_re_loop");
  in.register_cmd(193, exec_Z3_mk_re_intersect, "Z3_mk_re_intersect");
  in.register_cmd(194, exec_Z3_mk_re_complement, "Z3_mk_re_complement");
  in.register_cmd(195, exec_Z3_mk_re_empty, "Z3_mk_re_empty");
  in.register_cmd(196, exec_Z3_mk_re_full, "Z3_mk_re_full");
  in.register_cmd(197, exec_Z3_mk_linear_order, "Z3_mk_linear_order");
  in.register_cmd(198, exec_Z3_mk_partial_order, "Z3_mk_partial_order");
  in.register_cmd(199, exec_Z3_mk_piecewise_linear_order, "Z3_mk_piecewise_linear_order");
  in.register_cmd(200, exec_Z3_mk_tree_order, "Z3_mk_tree_order");
  in.register_cmd(201, exec_Z3_mk_transitive_closure, "Z3_mk_transitive_closure");
  in.register_cmd(202, exec_Z3_mk_transitive_reflexive_closure, "Z3_mk_transitive_reflexive_closure");
