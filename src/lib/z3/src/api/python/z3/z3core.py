...
_lib.Z3_mk_linear_order.restype = Ast
_lib.Z3_mk_linear_order.argtypes = [ContextObj, ctypes.c_uint, Ast, Ast]
_lib.Z3_mk_partial_order.restype = Ast
_lib.Z3_mk_partial_order.argtypes = [ContextObj, ctypes.c_uint, Ast, Ast]
_lib.Z3_mk_piecewise_linear_order.restype = Ast
_lib.Z3_mk_piecewise_linear_order.argtypes = [ContextObj, ctypes.c_uint, Ast, Ast]
_lib.Z3_mk_tree_order.restype = Ast
_lib.Z3_mk_tree_order.argtypes = [ContextObj, ctypes.c_uint, Ast, Ast]
_lib.Z3_mk_transitive_closure.restype = FuncDecl
_lib.Z3_mk_transitive_closure.argtypes = [ContextObj, FuncDecl]
_lib.Z3_mk_transitive_reflexive_closure.restype = FuncDecl
_lib.Z3_mk_transitive_reflexive_closure.argtypes = [ContextObj, FuncDecl]
...
def Z3_mk_linear_order(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_linear_order)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r

def Z3_mk_partial_order(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_partial_order)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r

def Z3_mk_piecewise_linear_order(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_piecewise_linear_order)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r

def Z3_mk_tree_order(a0, a1, a2, a3, _elems=Elementaries(_lib.Z3_mk_tree_order)):
  r = _elems.f(a0, a1, a2, a3)
  _elems.Check(a0)
  return r
...
def Z3_mk_transitive_reflexive_closure(a0, a1, _elems=Elementaries(_lib.Z3_mk_transitive_reflexive_closure)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r
