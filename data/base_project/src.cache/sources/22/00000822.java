...
/* loaded from: EnvironmentalReverb.class */
public class EnvironmentalReverb extends AudioEffect {
    ...
    /* loaded from: EnvironmentalReverb$OnParameterChangeListener.class */
    ...
    /* loaded from: EnvironmentalReverb$BaseParameterListener.class */
    private class BaseParameterListener implements AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(AudioEffect effect, int status, byte[] param, byte[] value) {
            ...
            if (l != null) {
                ...
                int v = -1;
                if (param.length == 4) {
                    p = EnvironmentalReverb.this.byteArrayToInt(param, 0);
                }
                if (value.length == 2) {
                    v = EnvironmentalReverb.this.byteArrayToShort(value, 0);
                } else if (value.length == 4) {
                    v = EnvironmentalReverb.this.byteArrayToInt(value, 0);
                }
                if (p != -1 && v != -1) {
    ...
    /* loaded from: EnvironmentalReverb$Settings.class */
