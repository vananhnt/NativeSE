...
public class EventLogTags {
    ...
    public static void writePdpBadDnsAddress(String dnsAddress) {
        EventLog.writeEvent((int) PDP_BAD_DNS_ADDRESS, dnsAddress);
    }

    public static void writePdpRadioResetCountdownTriggered(int outPacketCount) {
        EventLog.writeEvent((int) PDP_RADIO_RESET_COUNTDOWN_TRIGGERED, outPacketCount);
    }

    public static void writePdpRadioReset(int outPacketCount) {
        EventLog.writeEvent((int) PDP_RADIO_RESET, outPacketCount);
    }

    public static void writePdpContextReset(int outPacketCount) {
        EventLog.writeEvent((int) PDP_CONTEXT_RESET, outPacketCount);
    }

    public static void writePdpReregisterNetwork(int outPacketCount) {
        EventLog.writeEvent((int) PDP_REREGISTER_NETWORK, outPacketCount);
    }

    public static void writePdpSetupFail(int cause, int cid, int networkType) {
        EventLog.writeEvent((int) PDP_SETUP_FAIL, Integer.valueOf(cause), Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeCallDrop(int cause, int cid, int networkType) {
        EventLog.writeEvent((int) CALL_DROP, Integer.valueOf(cause), Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeDataNetworkRegistrationFail(int opNumeric, int cid) {
        EventLog.writeEvent((int) DATA_NETWORK_REGISTRATION_FAIL, Integer.valueOf(opNumeric), Integer.valueOf(cid));
    }

    public static void writeDataNetworkStatusOnRadioOff(String dcState, int enable) {
        EventLog.writeEvent((int) DATA_NETWORK_STATUS_ON_RADIO_OFF, dcState, Integer.valueOf(enable));
    }

    public static void writePdpNetworkDrop(int cid, int networkType) {
        EventLog.writeEvent((int) PDP_NETWORK_DROP, Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeCdmaDataSetupFailed(int cause, int cid, int networkType) {
        EventLog.writeEvent((int) CDMA_DATA_SETUP_FAILED, Integer.valueOf(cause), Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeCdmaDataDrop(int cid, int networkType) {
        EventLog.writeEvent((int) CDMA_DATA_DROP, Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeGsmRatSwitched(int cid, int networkFrom, int networkTo) {
        EventLog.writeEvent((int) GSM_RAT_SWITCHED, Integer.valueOf(cid), Integer.valueOf(networkFrom), Integer.valueOf(networkTo));
    }

    public static void writeGsmDataStateChange(String oldstate, String newstate) {
        EventLog.writeEvent((int) GSM_DATA_STATE_CHANGE, oldstate, newstate);
    }

    public static void writeGsmServiceStateChange(int oldstate, int oldgprsstate, int newstate, int newgprsstate) {
        EventLog.writeEvent((int) GSM_SERVICE_STATE_CHANGE, Integer.valueOf(oldstate), Integer.valueOf(oldgprsstate), Integer.valueOf(newstate), Integer.valueOf(newgprsstate));
    }

    public static void writeCdmaDataStateChange(String oldstate, String newstate) {
        EventLog.writeEvent((int) CDMA_DATA_STATE_CHANGE, oldstate, newstate);
    }

    public static void writeCdmaServiceStateChange(int oldstate, int olddatastate, int newstate, int newdatastate) {
        EventLog.writeEvent((int) CDMA_SERVICE_STATE_CHANGE, Integer.valueOf(oldstate), Integer.valueOf(olddatastate), Integer.valueOf(newstate), Integer.valueOf(newdatastate));
    }

    public static void writeBadIpAddress(String ipAddress) {
        EventLog.writeEvent((int) BAD_IP_ADDRESS, ipAddress);
    }

    public static void writeDataStallRecoveryGetDataCallList(int outPacketCount) {
        EventLog.writeEvent((int) DATA_STALL_RECOVERY_GET_DATA_CALL_LIST, outPacketCount);
    }

    public static void writeDataStallRecoveryCleanup(int outPacketCount) {
        EventLog.writeEvent((int) DATA_STALL_RECOVERY_CLEANUP, outPacketCount);
    }

    public static void writeDataStallRecoveryReregister(int outPacketCount) {
        EventLog.writeEvent((int) DATA_STALL_RECOVERY_REREGISTER, outPacketCount);
    }

    public static void writeDataStallRecoveryRadioRestart(int outPacketCount) {
        EventLog.writeEvent((int) DATA_STALL_RECOVERY_RADIO_RESTART, outPacketCount);
    }

    public static void writeDataStallRecoveryRadioRestartWithProp(int outPacketCount) {
        EventLog.writeEvent((int) DATA_STALL_RECOVERY_RADIO_RESTART_WITH_PROP, outPacketCount);
    }

    public static void writeGsmRatSwitchedNew(int cid, int networkFrom, int networkTo) {
        EventLog.writeEvent((int) GSM_RAT_SWITCHED_NEW, Integer.valueOf(cid), Integer.valueOf(networkFrom), Integer.valueOf(networkTo));
    }

    public static void writeExpDetSmsDeniedByUser(String appSignature) {
        EventLog.writeEvent((int) EXP_DET_SMS_DENIED_BY_USER, appSignature);
    }

    public static void writeExpDetSmsSentByUser(String appSignature) {
        EventLog.writeEvent((int) EXP_DET_SMS_SENT_BY_USER, appSignature);
    }
}