...
/* loaded from: IApplicationThread.class */
public interface IApplicationThread extends IInterface {
    ...
    void scheduleResumeActivity(IBinder iBinder, int i, boolean z) throws RemoteException;
    ...
    void setHttpProxy(String str, String str2, String str3, String str4) throws RemoteException;
    ...
    void profilerControl(boolean z, String str, ParcelFileDescriptor parcelFileDescriptor, int i) throws RemoteException;
    ...
    void dumpMemInfo(FileDescriptor fileDescriptor, Debug.MemoryInfo memoryInfo, boolean z, boolean z2, boolean z3, String[] strArr) throws RemoteException;
