...
/* loaded from: SearchableInfo.class */
public final class SearchableInfo implements Parcelable {
    ...
    public boolean useBadgeIcon() {
        return (0 == (this.mSearchMode & 8) || this.mIconId == 0) ? false : true;
    }

    public boolean shouldRewriteQueryFromData() {
        return 0 != (this.mSearchMode & 16);
    }

    public boolean shouldRewriteQueryFromText() {
        return 0 != (this.mSearchMode & 32);
    }
    ...
    private SearchableInfo(Context activityContext, AttributeSet attr, ComponentName cName) {
        ...
        if (this.mSuggestAuthority != null) {
            ...
            ProviderInfo pi = pm.resolveContentProvider(this.mSuggestAuthority, 0);
            if (pi != null) {
    ...
    /* loaded from: SearchableInfo$ActionKeyInfo.class */
