...
/* loaded from: PresetReverb.class */
public class PresetReverb extends AudioEffect {
    ...
    /* loaded from: PresetReverb$OnParameterChangeListener.class */
    ...
    /* loaded from: PresetReverb$BaseParameterListener.class */
    private class BaseParameterListener implements AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(AudioEffect effect, int status, byte[] param, byte[] value) {
            ...
            if (l != null) {
                ...
                short v = -1;
                if (param.length == 4) {
                    p = PresetReverb.this.byteArrayToInt(param, 0);
                }
                if (value.length == 2) {
                    v = PresetReverb.this.byteArrayToShort(value, 0);
                }
                if (p != -1 && v != -1) {
    ...
    /* loaded from: PresetReverb$Settings.class */
