...
public class SIPDate implements Cloneable, Serializable {
    ...
    public String encode() {
        ...
        String encoding2 = encoding + dayString + Separators.SP;
        if (this.sipMonth != null) {
            encoding2 = encoding2 + this.sipMonth + Separators.SP;
        }
        return encoding2 + this.year + Separators.SP + hourString + Separators.COLON + minuteString + Separators.COLON + secondString + Separators.SP + "GMT";
    }
