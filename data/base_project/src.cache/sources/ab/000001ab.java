...
/* loaded from: LauncherActivity.class */
public abstract class LauncherActivity extends ListActivity {
    Intent mIntent;
    PackageManager mPackageManager;
    IconResizer mIconResizer;

    /* loaded from: LauncherActivity$ListItem.class */
    ...
    /* loaded from: LauncherActivity$ActivityAdapter.class */
    public class ActivityAdapter extends BaseAdapter implements Filterable {
        ...
        /* loaded from: LauncherActivity$ActivityAdapter$ArrayFilter.class */
            ...
            protected Filter.FilterResults performFiltering(CharSequence prefix) {
                ...
                if (prefix == null || prefix.length() == 0) {
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        String[] words = item.label.toString().toLowerCase().split(Separators.SP);
    ...
    /* loaded from: LauncherActivity$IconResizer.class */
