...
public final class Types {
    ...
    static {
        ...
        PRIMITIVE_TO_SIGNATURE.put(Character.TYPE, TokenNames.C);
        PRIMITIVE_TO_SIGNATURE.put(Short.TYPE, TokenNames.S);
        PRIMITIVE_TO_SIGNATURE.put(Integer.TYPE, TokenNames.I);
        PRIMITIVE_TO_SIGNATURE.put(Long.TYPE, "J");
        PRIMITIVE_TO_SIGNATURE.put(Float.TYPE, TokenNames.F);
        PRIMITIVE_TO_SIGNATURE.put(Double.TYPE, "D");
        PRIMITIVE_TO_SIGNATURE.put(Void.TYPE, TokenNames.V);
    ...
    public static String getSignature(Class<?> clazz) {
        ...
        return TokenNames.L + clazz.getName() + Separators.SEMICOLON;
    }
