...
/* loaded from: AndroidHttpClient.class */
public final class AndroidHttpClient implements HttpClient {
    ...
    /* loaded from: AndroidHttpClient$LoggingConfiguration.class */
    ...
    /* loaded from: AndroidHttpClient$CurlLogger.class */
            ...
            if (entity != null && entity.isRepeatable()) {
                if (entity.getContentLength() < 1024) {
                    ...
                    if (isBinaryContent(request)) {
                        ...
                        builder.append(" --data-ascii \"").append(entityString).append(Separators.DOUBLE_QUOTE);
                    }
                } else {
