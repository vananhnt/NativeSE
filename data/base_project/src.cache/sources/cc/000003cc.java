...
/* loaded from: CompatibilityInfo.class */
public class CompatibilityInfo implements Parcelable {
    ...
    /* loaded from: CompatibilityInfo$Translator.class */
    ...
    public int hashCode() {
        int result = (31 * 17) + this.mCompatibilityFlags;
        return (31 * ((31 * ((31 * result) + this.applicationDensity)) + Float.floatToIntBits(this.applicationScale))) + Float.floatToIntBits(this.applicationInvertedScale);
    }
