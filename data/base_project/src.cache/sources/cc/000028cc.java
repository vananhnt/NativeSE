...
/* loaded from: NativeCollation.class */
public final class NativeCollation {
    ...
    public static native int getCollationElementIterator(long j, String str);

    public static native String getRules(long j);

    public static native byte[] getSortKey(long j, String str);

    public static native long openCollator(String str);
