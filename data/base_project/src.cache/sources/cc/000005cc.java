...
public class Camera {
    ...
    /* loaded from: Camera$AutoFocusCallback.class */
    public interface AutoFocusCallback {
        void onAutoFocus(boolean z, Camera camera);
    }

    /* loaded from: Camera$AutoFocusMoveCallback.class */
    public interface AutoFocusMoveCallback {
        void onAutoFocusMoving(boolean z, Camera camera);
    }

    /* loaded from: Camera$CameraInfo.class */
    ...
    /* loaded from: Camera$ErrorCallback.class */
    public interface ErrorCallback {
        void onError(int i, Camera camera);
    }

    /* loaded from: Camera$Face.class */
    ...
    /* loaded from: Camera$FaceDetectionListener.class */
    public interface FaceDetectionListener {
        void onFaceDetection(Face[] faceArr, Camera camera);
    }

    /* loaded from: Camera$OnZoomChangeListener.class */
    public interface OnZoomChangeListener {
        void onZoomChange(int i, boolean z, Camera camera);
    }

    /* loaded from: Camera$PictureCallback.class */
    public interface PictureCallback {
        void onPictureTaken(byte[] bArr, Camera camera);
    }

    /* loaded from: Camera$PreviewCallback.class */
    public interface PreviewCallback {
        void onPreviewFrame(byte[] bArr, Camera camera);
    }

    /* loaded from: Camera$ShutterCallback.class */
    ...
    /* loaded from: Camera$EventHandler.class */
    ...
    /* loaded from: Camera$Parameters.class */
    public class Parameters {
        ...
        public void dump() {
            ...
            for (String k : this.mMap.keySet()) {
                Log.e(Camera.TAG, "dump: " + k + Separators.EQUALS + this.mMap.get(k));
            }
        }
        ...
        public String flatten() {
            ...
            for (String k : this.mMap.keySet()) {
                flattened.append(k);
                flattened.append(Separators.EQUALS);
                flattened.append(this.mMap.get(k));
                flattened.append(Separators.SEMICOLON);
            }
        ...
        public void setPreviewFpsRange(int min, int max) {
            set(KEY_PREVIEW_FPS_RANGE, "" + min + Separators.COMMA + max);
        }
