...
/* loaded from: GenericInflater.class */
public abstract class GenericInflater<T, P extends Parent> {
    ...
    /* loaded from: GenericInflater$Factory.class */
    public interface Factory<T> {
        T onCreateItem(String str, Context context, AttributeSet attributeSet);
    }

    /* loaded from: GenericInflater$Parent.class */
    ...
    /* loaded from: GenericInflater$FactoryMerger.class */
    ...
    public T inflate(int resource, P root, boolean attachToRoot) {
        ...
        try {
            T inflate = inflate((XmlPullParser) parser, (XmlResourceParser) root, attachToRoot);
            parser.close();
            return inflate;
        } catch (Throwable th) {
            parser.close();
