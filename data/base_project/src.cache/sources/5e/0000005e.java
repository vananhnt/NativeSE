...
/* loaded from: GrantCredentialsPermissionActivity.class */
    ...
    public void finish() {
        ...
        if (response != null) {
            if (this.mResultBundle != null) {
                ...
                response.onError(4, SyncStorageEngine.MESG_CANCELED);
            }
        }
        super.finish();
    }
