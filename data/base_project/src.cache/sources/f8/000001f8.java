...
public abstract class Service extends ContextWrapper implements ComponentCallbacks2 {
    ...
    public final void startForeground(int id, Notification notification) {
        try {
            this.mActivityManager.setServiceForeground(new ComponentName(this, this.mClassName), this.mToken, id, notification, true);
        } catch (RemoteException e) {
        }
    }
    ...
    public final void stopForeground(boolean removeNotification) {
        try {
            this.mActivityManager.setServiceForeground(new ComponentName(this, this.mClassName), this.mToken, 0, null, removeNotification);
        } catch (RemoteException e) {
        }
    }
