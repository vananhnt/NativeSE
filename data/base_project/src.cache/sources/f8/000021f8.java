...
/* loaded from: ParserFactory.class */
public class ParserFactory {
    ...
    static {
        ...
        parserTable.put(FullBackup.DATA_TREE_TOKEN, FromParser.class);
        parserTable.put("CSeq".toLowerCase(), CSeqParser.class);
        parserTable.put("Via".toLowerCase(), ViaParser.class);
        parserTable.put(Telephony.BaseMmsColumns.MMS_VERSION, ViaParser.class);
        ...
        parserTable.put(FullBackup.CACHE_TREE_TOKEN, ContentTypeParser.class);
        ...
        parserTable.put(FullBackup.ROOT_TREE_TOKEN, ReferToParser.class);
