...
/* loaded from: WebVttRenderingWidget.class */
public class WebVttRenderingWidget extends ViewGroup implements SubtitleTrack.RenderingWidget {
    ...
    public WebVttRenderingWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mCaptioningListener = new CaptioningManager.CaptioningChangeListener() { // from class: android.media.WebVttRenderingWidget.1
            ...
            public void onFontScaleChanged(float fontScale) {
                float fontSize = fontScale * WebVttRenderingWidget.this.getHeight() * WebVttRenderingWidget.LINE_HEIGHT_RATIO;
    ...
    private void layoutRegion(int viewportWidth, int viewportHeight, RegionLayout regionBox) {
        ...
        int left = (int) ((x * (viewportWidth - regionWidth)) / 100.0f);
        int top = (int) ((y * (viewportHeight - regionHeight)) / 100.0f);
    ...
    private void layoutCue(int viewportWidth, int viewportHeight, CueLayout cueBox) {
        ...
        if (cueSnapToLines) {
            int paddingLeft = (100 * getPaddingLeft()) / viewportWidth;
            int paddingRight = (100 * getPaddingRight()) / viewportWidth;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: WebVttRenderer.java */
    /* loaded from: WebVttRenderingWidget$RegionLayout.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: WebVttRenderer.java */
    /* loaded from: WebVttRenderingWidget$CueLayout.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: WebVttRenderer.java */
    /* loaded from: WebVttRenderingWidget$SpanLayout.class */
