...
public class AudioEffect {
    ...
    /* loaded from: AudioEffect$OnControlStatusChangeListener.class */
    public interface OnControlStatusChangeListener {
        void onControlStatusChange(AudioEffect audioEffect, boolean z);
    }

    /* loaded from: AudioEffect$OnEnableStatusChangeListener.class */
    public interface OnEnableStatusChangeListener {
        void onEnableStatusChange(AudioEffect audioEffect, boolean z);
    }

    /* loaded from: AudioEffect$OnParameterChangeListener.class */
    ...
    /* loaded from: AudioEffect$Descriptor.class */
    ...
    /* loaded from: AudioEffect$NativeEventHandler.class */
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    if (parameterChangeListener != null) {
                        ...
                        byte[] p = (byte[]) msg.obj;
                        int status = AudioEffect.this.byteArrayToInt(p, 0);
                        int psize = AudioEffect.this.byteArrayToInt(p, 4);
                        int vsize = AudioEffect.this.byteArrayToInt(p, 8);
