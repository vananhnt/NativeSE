...
/* loaded from: ExpandableListConnector.class */
class ExpandableListConnector extends BaseAdapter implements Filterable {
    ...
    public void refreshExpGroupMetadataList(boolean forceChildrenCountRefresh, boolean syncGroupPositions) {
        ...
        for (int i2 = 0; i2 < egmlSize; i2++) {
            ...
            if (curGm2.lastChildFlPos == -1 || forceChildrenCountRefresh) {
                childrenCount = this.mExpandableListAdapter.getChildrenCount(curGm2.gPos);
            } else {
                childrenCount = curGm2.lastChildFlPos - curGm2.flPos;
            }
            int gChildrenCount = childrenCount;
    ...
    /* loaded from: ExpandableListConnector$MyDataSetObserver.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: ExpandableListConnector$GroupMetadata.class */
    ...
    /* loaded from: ExpandableListConnector$PositionMetadata.class */
