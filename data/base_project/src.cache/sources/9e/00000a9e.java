...
/* loaded from: GLLogWrapper.class */
public class GLLogWrapper extends GLWrapperBase {
    ...
    private String getPointerTypeName(int type) {
        switch (type) {
            ...
            case 5122:
                return "GL_SHORT";
            case 5123:
            case GLES20.GL_INT /* 5124 */:
            case GLES20.GL_UNSIGNED_INT /* 5125 */:
            case 5127:
            case 5128:
            case 5129:
            case 5130:
            case GLES30.GL_HALF_FLOAT /* 5131 */:
            default:
                return getHex(type);
            case 5126:
                return "GL_FLOAT";
            ...
            for (int i = 0; i < size; i++) {
                ...
                switch (type) {
                    ...
                    case 5121:
                        ...
                        builder.append(Integer.toString(255 & d2));
                        break;
                    case 5122:
    ...
    private void doElement(StringBuilder builder, int ordinal, int vertexIndex) {
        ...
        builder.append(Separators.RETURN);
    }
    ...
    public void glDrawArrays(int mode, int first, int count) {
        ...
        arg("mode", mode);
        arg("first", first);
        arg(HardwareRenderer.OVERDRAW_PROPERTY_COUNT, count);
        startLogIndices();
        for (int i = 0; i < count; i++) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: GLLogWrapper$PointerInfo.class */
