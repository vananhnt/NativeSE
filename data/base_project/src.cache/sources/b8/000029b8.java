...
/* loaded from: SHA1Impl.class */
public class SHA1Impl {
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void computeHash(int[] arrW) {
        int a = arrW[82];
        int b = arrW[83];
        int c = arrW[84];
        int d = arrW[85];
        ...
        for (int t2 = 0; t2 < 20; t2++) {
            int temp2 = ((a << 5) | (a >>> 27)) + ((b & c) | ((b ^ (-1)) & d)) + e + arrW[t2] + 1518500249;
            e = d;
            d = c;
            c = (b << 30) | (b >>> 2);
            b = a;
        ...
        for (int t3 = 20; t3 < 40; t3++) {
            int temp3 = ((a << 5) | (a >>> 27)) + ((b ^ c) ^ d) + e + arrW[t3] + 1859775393;
            e = d;
            d = c;
            c = (b << 30) | (b >>> 2);
            b = a;
        ...
        for (int t4 = 40; t4 < 60; t4++) {
            int temp4 = ((a << 5) | (a >>> 27)) + ((b & c) | (b & d) | (c & d)) + ((e + arrW[t4]) - 1894007588);
            e = d;
            d = c;
            c = (b << 30) | (b >>> 2);
            b = a;
        ...
        for (int t5 = 60; t5 < 80; t5++) {
            int temp5 = ((a << 5) | (a >>> 27)) + ((b ^ c) ^ d) + ((e + arrW[t5]) - 899497514);
            e = d;
            d = c;
            c = (b << 30) | (b >>> 2);
            b = a;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void updateHash(int[] intArray, byte[] byteInput, int fromByte, int toByte) {
