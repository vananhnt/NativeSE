        ...
        if (this.mParent != null && ((ConstraintWidgetContainer) this.mParent).optimizeFor(2)) {
            ...
            for (int i3 = 0; i3 < this.mWidgetsCount; i3++) {
                ...
                if (this.mAllowsGoneWidget || constraintWidget.allowedInBarrier()) {
                    ...
                    switch (this.mBarrierType) {
                        case 0:
                            resolutionAnchor = constraintWidget.mLeft.getResolutionNode();
                            break;
                        case 1:
                            resolutionAnchor = constraintWidget.mRight.getResolutionNode();
                            break;
                        case 2:
                            resolutionAnchor = constraintWidget.mTop.getResolutionNode();
                            break;
                        case 3:
                            resolutionAnchor = constraintWidget.mBottom.getResolutionNode();
                            break;
                    }
