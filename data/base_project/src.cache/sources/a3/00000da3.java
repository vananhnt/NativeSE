...
/* loaded from: ProgramRaster.class */
public class ProgramRaster extends BaseObj {
    boolean mPointSprite;
    CullMode mCullMode;

    /* loaded from: ProgramRaster$CullMode.class */
    ...
    /* loaded from: ProgramRaster$Builder.class */
    public static class Builder {
        ...
        public ProgramRaster create() {
            this.mRS.validate();
            int id = this.mRS.nProgramRasterCreate(this.mPointSprite, this.mCullMode.mID);
