...
public abstract class Filter {
    ...
    public String toString() {
        return Separators.QUOTE + getName() + "' (" + getFilterClassName() + Separators.RPAREN;
    }
    ...
    private final void addAndSetFinalPorts(KeyValueMap values) {
        ...
        Field[] arr$ = filterClass.getDeclaredFields();
        for (Field field : arr$) {
            ...
            if (annotation != null) {
                ...
                if (annotation2 != null) {
                    ...
                    if (annotation3 != null) {
                        ...
                        GenerateProgramPort[] arr$2 = generators.value();
                        for (GenerateProgramPort generator3 : arr$2) {
