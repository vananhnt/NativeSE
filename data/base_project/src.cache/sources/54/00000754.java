...
public class JetPlayer {
    ...
    /* loaded from: JetPlayer$OnJetEventListener.class */
    ...
    private JetPlayer() {
        ...
        int buffSizeInBytes = AudioTrack.getMinBufferSize(22050, 12, 2);
        if (buffSizeInBytes != -1 && buffSizeInBytes != -2) {
            native_setup(new WeakReference(this), getMaxTracks(), Math.max(1200, buffSizeInBytes / 4));
        }
    }
    ...
    /* loaded from: JetPlayer$NativeEventHandler.class */
