...
public interface IAssetAtlas extends IInterface {
    ...
    /* loaded from: IAssetAtlas$Stub.class */
    public static abstract class Stub extends Binder implements IAssetAtlas {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    boolean _result = isCompatible(_arg0);
        ...
        /* loaded from: IAssetAtlas$Stub$Proxy.class */
        public static class Proxy implements IAssetAtlas {
            ...
            public GraphicBuffer getBuffer() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (0 != _reply.readInt()) {
                        _result = GraphicBuffer.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
