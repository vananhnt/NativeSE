...
public class WebAddress {
        ...
        if (m.matches()) {
            ...
            if (t5 != null && t5.length() > 0) {
                if (t5.charAt(0) == '/') {
                    ...
                    this.mPath = Separators.SLASH + t5;
                }
            }
    ...
    public String toString() {
        ...
        if ((this.mPort != 443 && this.mScheme.equals("https")) || (this.mPort != 80 && this.mScheme.equals("http"))) {
            port = Separators.COLON + Integer.toString(this.mPort);
        }
        String authInfo = "";
        if (this.mAuthInfo.length() > 0) {
            authInfo = this.mAuthInfo + Separators.AT;
        }
