...
/* loaded from: UrlQuerySanitizer.class */
public class UrlQuerySanitizer {
    ...
    /* loaded from: UrlQuerySanitizer$ValueSanitizer.class */
    public interface ValueSanitizer {
        String sanitize(String str);
    }

    /* loaded from: UrlQuerySanitizer$ParameterValuePair.class */
    ...
    /* loaded from: UrlQuerySanitizer$IllegalCharacterValueSanitizer.class */
    ...
    public void parseQuery(String query) {
        clear();
        StringTokenizer tokenizer = new StringTokenizer(query, Separators.AND);
