...
public class SipFactory {
    ...
    public synchronized SipStack createSipStack(Properties properties) throws PeerUnavailableException {
        ...
        if (sipStack == null) {
            ...
            try {
                sipStack = (SipStack) Class.forName(implClassName).asSubclass(SipStack.class).getConstructor(Properties.class).newInstance(properties);
