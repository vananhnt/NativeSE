...
/* loaded from: ArrayLinkedVariables.class */
public class ArrayLinkedVariables {
    ...
    public final void add(SolverVariable solverVariable, float f, boolean z) {
        ...
        if (this.mDidFillOnce) {
            ...
            i7 = iArr3[i6] == -1 ? this.mLast : iArr3.length;
        }
    ...
    public SolverVariable chooseSubject(LinearSystem linearSystem) {
        ...
        while (i != -1 && i2 < this.currentSize) {
            ...
            } else if (solverVariable3.mType == SolverVariable.Type.UNRESTRICTED) {
    ...
    public void display() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                System.out.print(variable + " = " + getVariableValue(i2) + Separators.SP);
            }
        }
        System.out.println(" }");
    }
    ...
    public final void put(SolverVariable solverVariable, float f) {
        if (f == 0.0f) {
            ...
            if (this.mDidFillOnce) {
                ...
                i7 = iArr2[i6] == -1 ? this.mLast : iArr2.length;
            }
            int[] iArr3 = this.mArrayIndices;
