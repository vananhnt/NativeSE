...
/* loaded from: SSLCertificateSocketFactory.class */
public class SSLCertificateSocketFactory extends SSLSocketFactory {
    ...
    private static boolean isSslCheckRelaxed() {
        return "1".equals(SystemProperties.get("ro.debuggable")) && AuthorizationHeaderIms.YES.equals(SystemProperties.get("socket.relaxsslcheck"));
    }
