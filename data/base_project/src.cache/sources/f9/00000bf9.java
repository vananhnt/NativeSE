...
/* loaded from: PreferenceManager.class */
public class PreferenceManager {
    ...
    /* loaded from: PreferenceManager$OnActivityDestroyListener.class */
    public interface OnActivityDestroyListener {
        void onActivityDestroy();
    }

    /* loaded from: PreferenceManager$OnActivityResultListener.class */
    public interface OnActivityResultListener {
        boolean onActivityResult(int i, int i2, Intent intent);
    }

    /* loaded from: PreferenceManager$OnActivityStopListener.class */
    public interface OnActivityStopListener {
        void onActivityStop();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: PreferenceManager$OnPreferenceTreeClickListener.class */
    ...
    public PreferenceScreen inflateFromIntent(Intent queryIntent, PreferenceScreen rootPreferences) {
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            if (metaData != null && metaData.containsKey(METADATA_KEY_PREFERENCES)) {
                String uniqueResId = activityInfo.packageName + Separators.COLON + activityInfo.metaData.getInt(METADATA_KEY_PREFERENCES);
