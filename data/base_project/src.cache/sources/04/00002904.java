...
public final class MimeUtils {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0xa8 in method: libcore.net.MimeUtils.applyOverrides():void, file: MimeUtils.class
    ...
    private static void applyOverrides() {
        /*
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0xa8 in method: libcore.net.MimeUtils.applyOverrides():void, file: MimeUtils.class
        */
        throw new UnsupportedOperationException("Method not decompiled: libcore.net.MimeUtils.applyOverrides():void");
    }
    ...
    static {
        ...
        add("audio/amr", "amr");
        add("audio/basic", "snd");
        add("audio/midi", Telephony.Mms.Part.MSG_ID);
        add("audio/midi", "midi");
        add("audio/midi", "kar");
        add("audio/midi", "xmf");
        ...
        add(ClipDescription.MIMETYPE_TEXT_HTML, "html");
        add("text/h323", "323");
        add("text/iuls", "uls");
        add("text/mathml", "mml");
        add("text/plain", "txt");
        ...
        add("text/x-csh", "csh");
        add("text/x-csrc", FullBackup.CACHE_TREE_TOKEN);
        add("text/x-dsrc", "d");
        ...
        add("video/mp4", "mp4");
        add("video/mpeg", "VOB");
        add("video/quicktime", Telephony.BaseMmsColumns.QUOTAS);
    ...
    private static InputStream getContentTypesPropertiesStream() {
        ...
        File f2 = new File(System.getProperty("java.home"), "lib" + File.separator + "content-types.properties");
        if (f2.exists()) {
            try {
