...
/* loaded from: SuggestionsAdapter.class */
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    /* loaded from: SuggestionsAdapter$ChildViewCache.class */
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + Separators.SLASH + parseInt;
            Drawable checkIconCache = checkIconCache(str2);
            if (checkIconCache != null) {
                return checkIconCache;
            }
            Drawable drawable = this.mProviderContext.getResources().getDrawable(parseInt);
