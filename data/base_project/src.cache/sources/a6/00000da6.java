...
/* loaded from: ProgramStore.class */
public class ProgramStore extends BaseObj {
    ...
    /* loaded from: ProgramStore$DepthFunc.class */
    ...
    /* loaded from: ProgramStore$BlendSrcFunc.class */
    ...
    /* loaded from: ProgramStore$BlendDstFunc.class */
    ...
    /* loaded from: ProgramStore$Builder.class */
    public static class Builder {
        ...
        public ProgramStore create() {
            this.mRS.validate();
            int id = this.mRS.nProgramStoreCreate(this.mColorMaskR, this.mColorMaskG, this.mColorMaskB, this.mColorMaskA, this.mDepthMask, this.mDither, this.mBlendSrc.mID, this.mBlendDst.mID, this.mDepthFunc.mID);
