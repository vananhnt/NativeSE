...
/* loaded from: ObjectFormat.class */
public class ObjectFormat {
    ...
    public static MutableFrameFormat fromObject(Object object, int target) {
        return object == null ? new MutableFrameFormat(8, target) : fromClass(object.getClass(), 0, target);
    }

    public static MutableFrameFormat fromObject(Object object, int count, int target) {
        return object == null ? new MutableFrameFormat(8, target) : fromClass(object.getClass(), count, target);
    }
