...
/* loaded from: IProcessObserver.class */
public interface IProcessObserver extends IInterface {
    ...
    /* loaded from: IProcessObserver$Stub.class */
    public static abstract class Stub extends Binder implements IProcessObserver {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    ...
                    onImportanceChanged(_arg02, _arg12, _arg22);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
        ...
        /* loaded from: IProcessObserver$Stub$Proxy.class */
