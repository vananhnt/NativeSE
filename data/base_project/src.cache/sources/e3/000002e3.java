...
/* loaded from: ContentProviderClient.class */
public class ContentProviderClient {
    ...
    public ParcelFileDescriptor openFile(Uri url, String mode, CancellationSignal signal) throws RemoteException, FileNotFoundException {
        ...
        try {
            ...
            ParcelFileDescriptor openFile = this.mContentProvider.openFile(this.mPackageName, url, mode, remoteSignal);
            afterRemote();
            return openFile;
        } catch (Throwable th) {
            afterRemote();
    ...
    /* loaded from: ContentProviderClient$NotRespondingRunnable.class */
