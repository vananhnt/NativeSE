...
public class Guideline extends ConstraintWidget {
    ...
    /* loaded from: Guideline$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final int[] $SwitchMap$android$support$constraint$solver$widgets$ConstraintAnchor$Type = new int[ConstraintAnchor.Type.values().length];
