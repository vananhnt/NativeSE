...
/* loaded from: SyncStateContract.class */
public class SyncStateContract {

    /* loaded from: SyncStateContract$Columns.class */
    ...
    /* loaded from: SyncStateContract$Constants.class */
    public static class Constants implements Columns {
        public static final String CONTENT_DIRECTORY = "syncstate";
    }

    /* loaded from: SyncStateContract$Helpers.class */
        ...
        public static Pair<Uri, byte[]> getWithUri(ContentProviderClient provider, Uri uri, Account account) throws RemoteException {
            ...
            try {
                if (c.moveToNext()) {
                    ...
                    byte[] blob = c.getBlob(c.getColumnIndexOrThrow("data"));
                    Pair<Uri, byte[]> create = Pair.create(ContentUris.withAppendedId(uri, rowId), blob);
                    c.close();
                    return create;
                }
                c.close();
