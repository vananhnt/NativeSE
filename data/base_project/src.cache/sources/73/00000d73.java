...
public class Element extends BaseObj {
    ...
    /* loaded from: Element$DataType.class */
    ...
    /* loaded from: Element$DataKind.class */
    ...
    public Element(int id, RenderScript rs) {
        super(id, rs);
    }
    ...
    public void updateFromNative() {
        ...
        DataKind[] arr$2 = DataKind.values();
        for (DataKind dk : arr$2) {
    ...
    /* loaded from: Element$Builder.class */
