...
public class ConstraintLayout extends ViewGroup {
    ...
    /* loaded from: ConstraintLayout$LayoutParams.class */
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        /* loaded from: ConstraintLayout$LayoutParams$Table.class */
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isGuideline && !layoutParams2.isHelper) {
                    ...
                    if (i7 == 0 || i8 == 0) {
                        ...
                        if (i7 != 0 || i8 != 0 || !z6 || !z7) {
                            boolean z8 = false;
                            boolean z9 = constraintLayout.mLayoutWidget.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                            boolean z10 = constraintLayout.mLayoutWidget.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                            if (!z9) {
                            ...
                            if (i7 == 0) {
                                if (z9 && constraintWidget2.isSpreadWidth() && z6 && resolutionNode.isResolved() && resolutionNode2.isResolved()) {
                                    i7 = (int) (resolutionNode2.getResolvedValue() - resolutionNode.getResolvedValue());
                                    constraintWidget2.getResolutionWidth().resolve(i7);
                            ...
                            } else if (z10 && constraintWidget2.isSpreadHeight() && z7 && resolutionNode3.isResolved() && resolutionNode4.isResolved()) {
                                z2 = z10;
                                i8 = (int) (resolutionNode4.getResolvedValue() - resolutionNode3.getResolvedValue());
                            ...
                            constraintWidget2.setWidthWrapContent(i7 == -2);
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.isGuideline) {
                    ...
                    int i7 = layoutParams.resolvedGuideBegin;
                    int i8 = layoutParams.resolvedGuideEnd;
                    ...
                    int i9 = layoutParams.resolvedLeftToLeft;
                    int i10 = layoutParams.resolvedLeftToRight;
                    int i11 = layoutParams.resolvedRightToLeft;
                    int i12 = layoutParams.resolvedRightToRight;
                    int i13 = layoutParams.resolveGoneLeftMargin;
                    int i14 = layoutParams.resolveGoneRightMargin;
                    float f2 = layoutParams.resolvedHorizontalBias;
                    if (Build.VERSION.SDK_INT < 17) {
                        i9 = layoutParams.leftToLeft;
                        i10 = layoutParams.leftToRight;
                        int i15 = layoutParams.rightToLeft;
                        i12 = layoutParams.rightToRight;
                        i13 = layoutParams.goneLeftMargin;
                        int i16 = layoutParams.goneRightMargin;
                        f2 = layoutParams.horizontalBias;
                        if (i9 == -1 && i10 == -1) {
                            if (layoutParams.startToStart != -1) {
                                i9 = layoutParams.startToStart;
                            } else if (layoutParams.startToEnd != -1) {
                                i10 = layoutParams.startToEnd;
                            }
                        }
                        if (i15 == -1 && i12 == -1) {
                            if (layoutParams.endToStart != -1) {
                                i14 = i16;
                                i11 = layoutParams.endToStart;
                            } else if (layoutParams.endToEnd != -1) {
                                i12 = layoutParams.endToEnd;
                                i11 = i15;
                                i14 = i16;
                            }
                        }
                    ...
                    if (layoutParams.circleConstraint != -1) {
                        ...
                        if (i9 != -1) {
                            ConstraintWidget targetWidget6 = getTargetWidget(i9);
                            if (targetWidget6 != null) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget6, ConstraintAnchor.Type.LEFT, layoutParams.leftMargin, i13);
                            }
                        } else if (i10 != -1 && (targetWidget = getTargetWidget(i10)) != null) {
                            viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget, ConstraintAnchor.Type.RIGHT, layoutParams.leftMargin, i13);
                        }
                        if (i11 != -1) {
                            ConstraintWidget targetWidget7 = getTargetWidget(i11);
                            if (targetWidget7 != null) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.RIGHT, targetWidget7, ConstraintAnchor.Type.LEFT, layoutParams.rightMargin, i14);
                            }
                        } else if (i12 != -1 && (targetWidget2 = getTargetWidget(i12)) != null) {
                            viewWidget2.immediateConnect(ConstraintAnchor.Type.RIGHT, targetWidget2, ConstraintAnchor.Type.RIGHT, layoutParams.rightMargin, i14);
                        }
    ...
    private void setSelfDimensionBehaviour(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            size = mode != 1073741824 ? 0 : Math.min(this.mMaxWidth, size) - (paddingLeft + paddingRight);
        } else {
            dimensionBehaviour = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
            size = 0;
        }
        if (mode2 == Integer.MIN_VALUE) {
            ...
            i3 = Math.min(this.mMaxHeight, size2) - (paddingTop + paddingBottom);
        }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    ...
                    if (split.length == 4) {
                        ...
                        canvas.drawLine(i2, i3 + i5, i2 + i4, i3, paint);
                    }
                }
            }
        }
