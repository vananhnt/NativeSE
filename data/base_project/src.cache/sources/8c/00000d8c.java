...
public class Matrix4f {
    ...
    public void loadPerspective(float fovy, float aspect, float near, float far) {
        float top = near * ((float) Math.tan((float) ((fovy * 3.141592653589793d) / 360.0d)));
        float bottom = -top;
    ...
    private float computeCofactor(int i, int j) {
        ...
        int r1 = (j + 2) % 4;
        int r2 = (j + 3) % 4;
        float minor = ((this.mMat[c0 + (4 * r0)] * ((this.mMat[c1 + (4 * r1)] * this.mMat[c2 + (4 * r2)]) - (this.mMat[c1 + (4 * r2)] * this.mMat[c2 + (4 * r1)]))) - (this.mMat[c0 + (4 * r1)] * ((this.mMat[c1 + (4 * r0)] * this.mMat[c2 + (4 * r2)]) - (this.mMat[c1 + (4 * r2)] * this.mMat[c2 + (4 * r0)])))) + (this.mMat[c0 + (4 * r2)] * ((this.mMat[c1 + (4 * r0)] * this.mMat[c2 + (4 * r1)]) - (this.mMat[c1 + (4 * r1)] * this.mMat[c2 + (4 * r0)])));
