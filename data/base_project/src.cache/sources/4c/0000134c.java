...
/* loaded from: CdmaCellLocation.class */
public class CdmaCellLocation extends CellLocation {
    ...
    public String toString() {
        return "[" + this.mBaseStationId + Separators.COMMA + this.mBaseStationLatitude + Separators.COMMA + this.mBaseStationLongitude + Separators.COMMA + this.mSystemId + Separators.COMMA + this.mNetworkId + "]";
    }
