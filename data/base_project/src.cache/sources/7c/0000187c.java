...
/* loaded from: SimpleAdapter.class */
public class SimpleAdapter extends BaseAdapter implements Filterable {
    ...
    /* loaded from: SimpleAdapter$ViewBinder.class */
    ...
    /* loaded from: SimpleAdapter$SimpleFilter.class */
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (h != null) {
                        ...
                        for (int j = 0; j < len; j++) {
                            ...
                            String[] words = str.split(Separators.SP);
