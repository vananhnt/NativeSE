...
public class Preference implements Comparable<Preference> {
    ...
    /* loaded from: Preference$OnPreferenceChangeInternalListener.class */
    ...
    /* loaded from: Preference$OnPreferenceChangeListener.class */
    public interface OnPreferenceChangeListener {
        boolean onPreferenceChange(Preference preference, Object obj);
    }

    /* loaded from: Preference$OnPreferenceClickListener.class */
    ...
    private void registerDependency() {
        ...
        throw new IllegalStateException("Dependency \"" + this.mDependencyKey + "\" not found for preference \"" + this.mKey + "\" (title: \"" + ((Object) this.mTitle) + Separators.DOUBLE_QUOTE);
    }
    ...
    protected boolean persistLong(long value) {
        if (shouldPersist()) {
            if (value == getPersistedLong(value ^ (-1))) {
                return true;
            }
            SharedPreferences.Editor editor = this.mPreferenceManager.getEditor();
