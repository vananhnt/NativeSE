...
/* loaded from: ConstraintSet.class */
public class ConstraintSet {
    ...
    /* loaded from: ConstraintSet$Constraint.class */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m652clone());
        }
    }
